...
export const Sidebar = () => {
  const { isOpen, closeSideMenu } = useContext(SidebarContext);
  ...
  return (
    <div className="hidden sm:block">
      ...
      <nav
        className={clsx(
          "fixed p-5 left-0 top-0 w-[500px] h-screen bg-gray-900/95 backdrop-blur z-20 shadow-2xl transform transition-all duration-500",
          {
      ...
      >
        ...
        <div>
          <a
            href="/#home"
            className="flex items-center mt-12 p-2 hover:bg-gray-800 rounded transition-all text-black"
          >
        ...
        <div className="flex justify-around pt-8 pb-2 border-b ">
